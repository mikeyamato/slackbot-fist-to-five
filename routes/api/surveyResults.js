...
function postSurvey(){
	...
	const textPortionJSON = encodeURIComponent(`[{"pretext": "Results...", "text": "fist: ${fist} one finger: ${oneFinger}  two fingers: ${twoFingers}  three fingers: ${threeFingers}  four fingers: ${fourFingers}  five fingers: ${fiveFingers}"}]`);
